...
/*
 * Calculate the SHA-1 of an array of big-endian words,
 and a bit length
 */
...
/* An OAuth message is represented as an object like this:
   ...
   They must be encoded before transmission and decoded after reception.   For example, this message object:
...
OAuth.setProperties = function setProperties(into, from) {
    if (typeof into != "undefined" && typeof from != "undefined") {
        for (var key in from) {
...
OAuth.setProperties(OAuth, // utility functions
{
    ...
    completeRequest: function(message, accessor) {
        ...
        if (typeof map.oauth_consumer_key == "undefined") {
            OAuth.setParameter(message, "oauth_consumer_key", accessor.consumerKey || "");
        }
        if (typeof map.oauth_token == "undefined" && typeof accessor.token != "undefined") {
            OAuth.setParameter(message, "oauth_token", accessor.token);
        }
        if (typeof map.oauth_version == "undefined") {
            OAuth.setParameter(message, "oauth_version", "1.0");
        }
        if (typeof map.oauth_timestamp == "undefined") {
            OAuth.setParameter(message, "oauth_timestamp", OAuth.timestamp());
        }
        if (typeof map.oauth_nonce == "undefined") {
...
OAuth.declareClass = function (parent, name, newConstructor) {
    ...
    if (typeof newConstructor != 'undefined' && typeof previous != "undefined") {
...
OAuth.setProperties(OAuth.SignatureMethod, // class members
{
    ...
    /** Subsequently,
 the given constructor will be used for the named methods.
        The constructor will be called with no parameters.
        The resulting object should usually implement getSignature(baseString).
        You can easily define such a constructor by calling makeSubclass,
 below.
     */
    registerMethodClass: function(names,
 classConstructor) {
    ...
    /** Create a subclass of OAuth.SignatureMethod,
 with the given getSignature function. */
